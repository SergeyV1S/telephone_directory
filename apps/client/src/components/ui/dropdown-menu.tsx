...
const DropdownMenuItem = ({
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      "focus:bg-accent cursor-pointer relative flex items-center gap-2 rounded-sm px-3 py-2 outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
      typographyVariants(),
      className
    )}
    {...props}
...
const DropdownMenuRadioItem = ({
  ...
  <DropdownMenuPrimitive.RadioItem
    ...
    className={cn(
      "relative flex items-center gap-2 cursor-pointer hover:bg-bright-blue hover:text-white rounded-sm outline-none py-2 pr-2 pl-8 data-[disabled]:opacity-50 [&_svg:not([class*='size-'])]:size-4",
      typographyVariants(),
      className
    )}
    {...props}
